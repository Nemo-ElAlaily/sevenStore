<?php
$database_name = "test10"; //without prefix
$database_user = "user_test"; //database name and database username are both similar, change the value if you want
$database_pass = "random_password";
$cpanel_username = "future";
$cpanel_pass = "R?a2!4qQTetG";

                    ...
                    <a href="{{ route('front.blog.details', $blog->slug) }}">
                        <article class="post format-gallery hentry">
                            ...
                            <div class="media-attachment">
                                <a href="{{ route('front.blog.details', $blog->slug) }}">
                                    <img width="430" height="245" src="{{ $blog->image_path }}"
                                        class="wp-post-image" alt="{{ $blog->slug }}" />
                                </a>
                                        ...
                                        <span class="posted-on">
                                            <a href="{{ route('front.blog.details', $blog->slug) }}" rel="bookmark">
                                                <time class="entry-date published"
                                                    datetime="2016-03-04T07:34:20+00:00">{{ $blog->created_at }}</time>
                                                <time class="updated" datetime="2016-03-04T18:46:11+00:00"
                                                    itemprop="datePublished">{{ $blog->updated_at }}</time>
                                            </a>
                                        </span>
                                    </div>
                                </header><!-- .entry-header -->

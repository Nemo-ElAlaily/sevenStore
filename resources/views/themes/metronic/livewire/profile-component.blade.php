                                                                        ...
                                                                        <tr>
                                                                            <td class="legendColorBox">
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        style="width:4px;height:0;border:5px solid rgb(52,152,219);overflow:hidden">
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="legendColorBox">
                                                                                <div
                                                                                    style="border:1px solid #ccc;padding:1px">
                                                                                    <div
                                                                                        style="width:4px;height:0;border:5px solid rgb(26,188,156);overflow:hidden">
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <td class="legendLabel">Number of orders
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="count"><span
                                                            class="woocommerce-Price-amount amount"><span
                                                                class="woocommerce-Price-currencySymbol">EGP</span>&nbsp;1,710.00</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="count"><span
                                                            class="woocommerce-Price-amount amount"><span
                                                                class="woocommerce-Price-currencySymbol">EGP</span>&nbsp;1,545.00</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <ul class="list-unstyled list-count">
                                                        ...
                                                        <li>
                                                            <a href="#" style="color: #73a724">
                                                                <span class="title">Completed</span> <span
                                                                    class="count">1</span>
                                                                <div class="clearfix"></div>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" style="color: #999">
                                                                <span class="title">Pending</span> <span
                                                                    class="count">0</span>
                                                                <div class="clearfix"></div>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" style="color: #21759b">
                                                                <span class="title">Processing</span> <span
                                                                    class="count">0</span>
                                                                <div class="clearfix"></div>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <a href="#" style="color: #e6db55">
                                                                <span class="title">Refunded</span> <span
                                                                    class="count">0</span>
                                                                <div class="clearfix"></div>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" style="color: #f0ad4e">
                                                                <span class="title">On hold</span> <span
                                                                    class="count">0</span>
                                                                <div class="clearfix"></div>
                                                            </a>
                                                        </li>
                                ...
                                <div class="dokan-dash-sidebar">
                                    <div id="dokan-navigation" aria-label="Menu">
                                        ...
                                        <ul class="dokan-dashboard-menu">
                                            ...
                                            <li class="orders" id="btnorders">
                                                <a href="javascript:void(0)"><i class="fa fa-shopping-cart"></i>
                                                    Orders</a>
                                            </li>
                                            <li class="withdraw" id="btwithdraw">
                                                <a href="javascript:void(0)"><i class="fa fa-upload"></i> Withdraw</a>
                                            </li>
                                            <li class="settings" id="btnsetting">
                                        ...
                                        <ul class="linksUsers">
                                            <li class="dokan-common-links dokan-clearfix">
                                                <a title="" class="tips" data-placement="top" href="#" target="_blank"
                                                    data-original-title="Visit Store"><i
                                                        class="fa fa-external-link-square-alt"></i></a>
                                            </li>
                                            <li>
                                                <a title="" class="tips" data-placement="top" href="#"
                                                    data-original-title="Edit Account"><i class="fa fa-user"></i></a>
                                            </li>
                                            <li>

                                                <a title="" class="tips" data-placement="top" href="#"
                                                    data-original-title="Log out"><i class="fa fa-power-off"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>

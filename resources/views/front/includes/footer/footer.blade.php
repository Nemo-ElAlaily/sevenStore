<footer id="colophon" class="site-footer">
            ...
            <div class="row">
                ...
                <div class="footer-contact col-xs-12 col-sm-12 col-md-5 col-md-pull-7">
                    ...
                    <div class="footer-address">
                        ...
                        <address>{{ $site_settings -> address }}, {{ $site_settings -> city }}, {{ $site_settings -> country }}</address>
                    </div><!-- /.footer-address -->
                    ...
                    <div class="footer-social-icons">
                        <ul class="social-icons list-unstyled">
                            @foreach($social_settings as $link)
                                ...
                                @endphp
                                <li><a class="fa fa-{{ strtolower($social_key) }}" href="{{ $social_value }}"></a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="pull-left flip copyright">&copy; <a href="#">{{ $site_settings -> title }}</a> - All Rights Reserved</div>
            <div class="pull-right flip payment">
                <div class="footer-payment-logo">
                    <ul class="cash-card card-inline">
                        <li class="card-item"><img src="{{ asset('front') }}/images/footer/payment-icon/1.png" alt="" width="52"></li>
                        <li class="card-item"><img src="{{ asset('front') }}/images/footer/payment-icon/2.png" alt="" width="52"></li>
                        <li class="card-item"><img src="{{ asset('front') }}/images/footer/payment-icon/3.png" alt="" width="52"></li>
                        <li class="card-item"><img src="{{ asset('front') }}/images/footer/payment-icon/4.png" alt="" width="52"></li>
                        <li class="card-item"><img src="{{ asset('front') }}/images/footer/payment-icon/5.png" alt="" width="52"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->

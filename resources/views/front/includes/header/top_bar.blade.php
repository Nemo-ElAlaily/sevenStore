        ...
        <nav>
            <ul id="menu-top-bar-left" class="nav nav-inline pull-left animate-dropdown flip">
                <li class="menu-item animate-dropdown"><a title="Welcome to Worldwide Electronics Store"
                        href="#">Welcome to {{ $site_settings->welcome_phrase }}</a></li>
            </ul>
        </nav>
            ...
            <ul id="menu-top-bar-right" class="nav nav-inline pull-right animate-dropdown flip">
                ...
                @guest
                    <li class="menu-item animate-dropdown"><a title="Login" href="{{ route('login') }}"><i
                                class="ec ec-user mr-1"></i> Register <span class="text-gray-50">or</span> Sign in</a></li>
                @endguest
                @auth
                    <li class="menu-item menu-item-has-children animate-dropdown dropdown"><a title="My Account" href="#"
                        ...
                        <ul role="menu" class="dropdown-menu">
                            <li class="dropdown-item"><a class="dropdown-item" title="My Profile" href="#">My Profile</a>
                            </li>

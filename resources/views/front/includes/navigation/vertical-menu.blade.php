<nav>
    <ul class="list-group vertical-menu yamm make-absolute">
        ...
        <li class="highlight menu-item animate-dropdown"><a title="Value of the Day" href="#">Value of the Day</a></li>

        <li class="highlight menu-item animate-dropdown"><a title="Top 100 Offers" href="#">Top 100 Offers</a></li>

        <li class="highlight menu-item animate-dropdown"><a title="New Arrivals" href="#">New Arrivals</a></li>
        ...
        <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown">
            ...
            @include('front.includes.navigation.vertical-menu-megamenu')
        </li>
        ...
        <li id="menu-item-2695" class="menu-item menu-item-has-children animate-dropdown dropdown">
            <a title="Accessories" data-hover="dropdown" href="#" data-toggle="dropdown" class="dropdown-toggle"
                aria-haspopup="true">Accessories</a>
            <ul role="menu" class=" dropdown-menu">
                <li class="menu-item animate-dropdown"><a title="Cases" href="#">Cases</a></li>
                <li class="menu-item animate-dropdown"><a title="Chargers" href="#">Chargers</a></li>
                <li class="menu-item animate-dropdown"><a title="Headphone Accessories" href="#">Headphone
                        Accessories</a></li>
                <li class="menu-item animate-dropdown"><a title="Headphone Cases" href="#">Headphone Cases</a></li>
                <li class="menu-item animate-dropdown"><a title="Headphones" href="#">Headphones</a></li>
                <li class="menu-item animate-dropdown"><a title="Computer Accessories" href="#">Computer Accessories</a>
                </li>
                <li class="menu-item animate-dropdown"><a title="Laptop Accessories" href="#">Laptop Accessories</a>
                </li>
            </ul>
        </li>
    </ul>

            ...
            <div class="woocommerce-billing-fields">
                ...
                <p id="first_name" class="form-row form-row form-row-first validate-required">
                    ...
                    <input type="text"
                           ...
                           id="first_name" name="first_name" class="input-text ">
                    @error('first_name')
                ...
                <p id="last_name" class="form-row form-row form-row-last validate-required">
                    ...
                    <input type="text"
                           ...
                           id="last_name" name="last_name" class="input-text ">
                    @error('last_name')
                    <span class="text-danger mx-1">{{ $message }}</span>
                    @enderror
                </p>
                ...
                <p id="company" class="form-row form-row form-row-wide">
                    ...
                    <input type="text"
                           wire:model="company"
                           id="company" name="company" class="input-text ">
                    @error('company')
                    <span class="text-danger mx-1">{{ $message }}</span>
                    @enderror
                </p>
                ...
                <p id="email" class="form-row form-row form-row-first validate-required validate-email">
                    ...
                    <input type="email"
                           ...
                           id="email" name="email" class="input-text ">
                ...
                <p id="phone" class="form-row form-row form-row-last validate-required validate-phone">
                    ...
                    <input type="tel"
                           wire:model="phone"
                           id="phone" name="phone" class="input-text ">
                    @error('phone')
                    <span class="text-danger mx-1">{{ $message }}</span>
                    @enderror
                </p>
                ...
                <p id="shipping_city" class="form-row form-row form-row-wide address-field validate-required" data-o_class="form-row form-row form-row-wide address-field validate-required">
                ...
                <p id="shipping_country" class="form-row form-row form-row-first validate-required validate-email">
                    ...
                    <input type="text"
                           ...
                           id="shipping_country" name="shipping_country" class="input-text ">
                    @error('shipping_country')
                    <span class="text-danger mx-1">{{ $message }}</span>
                    @enderror
                </p>

                <p id="shipping_postcode" class="form-row form-row form-row-last address-field validate-postcode validate-required" data-o_class="form-row form-row form-row-last address-field validate-required validate-postcode">
                    <label class="" for="shipping_postcode">Postcode / ZIP
                        <abbr title="required" class="required">*</abbr>
                    </label>
                    <input type="text"
                           wire:model="shipping_postcode"
...
{{--                </p>--}}
                ...
                <p class="form-row form-row-wide create-account">
                    <input type="checkbox" value="1" name="make_main_data" id="make_main_data" class="input-checkbox" wire:model="make_main_data">
                ...
                <div class="woocommerce-checkout-payment" id="payment">
                    <ul class="wc_payment_methods payment_methods methods">
                        ...
                        <li class="wc_payment_method payment_method_bacs">
                            <input type="radio" data-order_button_text="" value="bacs" name="payment_method" class="input-radio" id="payment_method_bacs"  wire:model="payment_method">
                        ...
                        <li class="wc_payment_method payment_method_cod">
                            <input type="radio" data-order_button_text="" value="cod" name="payment_method" class="input-radio" id="payment_method_cod"  wire:model="payment_method">
                        ...
                        <li class="wc_payment_method payment_method_paypal">
                            <input type="radio" data-order_button_text="Proceed to PayPal" value="fawry" name="payment_method" class="input-radio" id="payment_method_fawry"  wire:model="payment_method">

                            <label for="payment_method_fawry">Fawry <img alt="PayPal Acceptance Mark" src="https://www.paypalobjects.com/webstatic/mktg/logo/AM_mc_vs_dc_ae.jpg">
                        ...
                        <li class="wc_payment_method payment_method_paypal">
                            <input type="radio" data-order_button_text="Proceed to PayPal" value="paymob" name="payment_method" class="input-radio" id="payment_method_paymob"  wire:model="payment_method">

                            <label for="payment_method_paymob">PayMob <img alt="PayPal Acceptance Mark" src="https://www.paypalobjects.com/webstatic/mktg/logo/AM_mc_vs_dc_ae.jpg">
                                <a title="What is PayMob?"
                                   onclick="javascript:window.open('https://www.paypal.com/us/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;"
                                   class="about_paypal"
                                   href="#">What is PayMob?</a>
                            </label>
                            <div style="display:none;" class="payment_box payment_method_paypal">
                                <p>Pay via PayMob; you can pay with your credit card if you don’t have a PayMob account.</p>
                            </div>
                        </li>
                    ...
                    <div class="form-row place-order">
                        ...
                        <p class="form-row terms wc-terms-and-conditions">
                            <input type="checkbox" id="terms" name="terms" class="input-checkbox" wire:model="terms" value="1">
                            <label class="checkbox" for="terms">I’ve read and accept the <a target="_blank" href="#">terms &amp; conditions</a> <span class="required">*</span></label>
                            @error('terms')
                            <span class="text-danger mx-1">{{ $message }}</span>
                            @enderror
                        </p>

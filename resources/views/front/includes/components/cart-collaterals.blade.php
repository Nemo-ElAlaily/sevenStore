    ...
    <div class="cart_totals ">
        ...
        <table class="shop_table shop_table_responsive">
            ...
            <tbody>
                ...
                <tr class="shipping">
                    <th>Shipping</th>
                    <td data-title="Shipping"><span class="amount">Free Shipping</span> <input type="hidden"
        ...
        <div class="wc-proceed-to-checkout">
            ...
            <a class="checkout-button button alt wc-forward" href="{{ route('front.checkout') }}">Proceed to
                Checkout</a>
        </div>
    </div>
</div>

        ...
        <div class="single_variation_wrap">
            ...
            <div class="woocommerce-variation-add-to-cart variations_button">
                <div class="quantity buttons_added">
                    ...
                    <input type="number" class="input-text qty text" value="1" name="qty" max="29" min="1" wire:model="qty">
                ...
                <button wire:click.prevent="store( '{{$product -> id}}', '{{$product -> name}}', '{{$product -> sale_price}}' )" class="single_add_to_cart_button button" >Add to cart</button>

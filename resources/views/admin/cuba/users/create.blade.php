            ...
            <div class="row bg-user p-4">
                ...
                <form class="col-10 box-shadow m-auto bg-user-child py-4" action="{{ route('admin.users.store') }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group col-sm-12  my-5 col-md-12">
                            ...
                            <div class="form-group col-sm-12 m4-5 col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2 text-center">
                            <div class="form-group">
                                <button type="submit" class="btn btn-pill btn-outline-secondary-2x"><i class="fa fa-plus"></i>

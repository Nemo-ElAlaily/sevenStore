                        ...
                        <form class="form-wizard" id="regForm" action="{{ route('admin.settings.database.store') }}" method="POST">
                            ...
                            <div class="tab">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="DB_DATABASE" type="text" placeholder="Database Name" required="required">
                                </div>
                                <div class="mb-3">
                                    <label for="DB_HOST">New Database Host</label>
                                    <input class="form-control" id="DB_HOST" type="text" placeholder="host">
                                </div>
                                <div class="mb-3">
                                    <label for="DB_USERNAME">New Database Username</label>
                                    <input class="form-control" id="DB_USERNAME" type="url" placeholder="Database Username">
                                </div>
                                <div class="mb-3">
                                    <label for="DB_PASSWORD">New Database Password</label>
                                    <input class="form-control" id="DB_PASSWORD" type="password" placeholder="Database Password">
                                </div>
                            </div>

    ...
    <div class="card card-solid">
        <div class="card-body">
            <div class="row">
                ...
                <form class="col-12" action="{{ route('admin.main_categories.store') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control input-thick create-category-input" type="text"
                                            name="name" placeholder="{{ trans('site.name') }}" value="{{ old('name') }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        @enderror
                                        <input class="form-control input-thick create-category-input " type="text"
                                            name="slug" placeholder="{{ trans('site.slug') }}" value="">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label class="create-category-label" label for="image">{{ trans('site.Image') }}</label>
                                        @error('image')

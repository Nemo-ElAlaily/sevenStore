                            ...
                            <div class="row">
                                ...
                                <div class="col mega-box">
                                    <div class="link-section">
                                        ...
                                        <ul>
                                            <li class="ps-0"><a href="#">Basic Email</a></li>
                                            <li class="ps-0"><a href="#">Basic With Header</a></li>
                                            <li class="ps-0"><a href="#">Ecomerce Template</a></li>
                                            <li class="ps-0"><a href="#">Email Template 2</a></li>
                                            <li class="ps-0"><a href="#">Ecommerce Email</a></li>
                                            <li class="ps-0"><a href="#">Order Success</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col mega-box">
                ...
                <li class="language-nav">
                    <div class="translate_wrapper">
                        <div class="current_lang">
                            <div class="lang"><i class="flag-icon flag-icon"></i><span class="lang-txt"> </span></div>
                        </div>
                        <div class="more_lang">
                            <a href="" class="">
                                <div class="" data-value="en"><i class="flag-icon flag-icon-us"></i> <span class="lang-txt">English</span><span> (US)</span></div>
                            </a>
                            <a href="#" class="">
                                <div class="" data-value="de"><i class="flag-icon flag-icon-de"></i> <span class="lang-txt">Deutsch</span></div>
                            </a>
                            <a href="" class="">
                                <div class="" data-value="es"><i class="flag-icon flag-icon-es"></i> <span class="lang-txt">Español</span></div>
                            </a>
                            <a href="">
                                <div class="" data-value="fr"><i class="flag-icon flag-icon-fr"></i> <span class="lang-txt">Français</span></div>
                            </a>
                            <a href="">
                                <div class="" data-value="pt"><i class="flag-icon flag-icon-pt"></i> <span class="lang-txt">Português</span><span> (BR)</span></div>
                            </a>
                            <a href="">
                                <div class="" data-value="cn"><i class="flag-icon flag-icon-cn"></i> <span class="lang-txt">简体中文</span></div>
                            </a>
                            <a href="">
                                <div class="" data-value="en"><i class="flag-icon flag-icon-ae"></i> <span class="lang-txt">لعربية</span> <span> (ae)</span></div>
                            </a>
                        </div>
                    </div>
                </li>
